      ...
      <div class="col-md-8" lang="de">
        <xsl:choose>
          <xsl:when test="/mcr_error/@HttpError = '500'">
              ...
              Gern können Sie uns eine Mail an<a href="mailto:publizieren.ub@fernuni-hagen.de">publizieren.ub@fernuni-hagen.de</a>
          ...
          <xsl:when test="/mcr_error/@HttpError = '404'">
              ...
              schreiben Sie eine Mail an <a href="mailto:publizieren.ub@fernuni-hagen.de">publizieren.ub@fernuni-hagen.de</a> und
          ...
          <xsl:when test="/mcr_error/@HttpError = '403'">
              ...
              schreiben Sie eine Mail an <a href="mailto:publizieren.ub@fernuni-hagen.de">publizieren.ub@fernuni-hagen.de</a>.
              <br/><br/>
              Vielen Dank!</p>
          </xsl:when>
          <xsl:otherwise>
              ...
              schreiben Sie bitte eine Mail an <a href="mailto:publizieren.ub@fernuni-hagen.de">publizieren.ub@fernuni-hagen.de</a> und
